...
/*See detail at http://lcdsantos.github.io/jQuery-Selectric/*/
...
(function() {
  jQuery(function() {
    $(".checkbox").checkbox();
    return $('select').selectric();
  });

}).call(this);
/**
 * Created by andrii on 29.07.15.
 */

$(document).ready(function() {
    $('#hs').on('click', function(event) {
        $('#displayBtnClick').toggle('show');
        $('#fBtn').toggle('hide');
    });
});
